...
"rallypointEchoMarker" setMarkerColorLocal _color;	//last marker command is public
"rallypointEchoMarker" setMarkerText format ["%1 Rallypoint",groupId group player];
