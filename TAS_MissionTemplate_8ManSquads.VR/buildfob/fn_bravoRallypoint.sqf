...
"rallypointBravoMarker" setMarkerColorLocal _color;	//last marker command is public
"rallypointBravoMarker" setMarkerText format ["%1 Rallypoint",groupId group player];
