...
"rallypointReconMarker" setMarkerColorLocal _color;	//last marker command is public
"rallypointReconMarker" setMarkerText format ["%1 Rallypoint",groupId group player];
