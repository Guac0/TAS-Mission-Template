...
"rallypointFoxtrotMarker" setMarkerColorLocal _color;	//last marker command is public
"rallypointFoxtrotMarker" setMarkerText format ["%1 Rallypoint",groupId group player];
