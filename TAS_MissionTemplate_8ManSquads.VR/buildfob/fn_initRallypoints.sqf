...
if (
	...
	private _Rally_CMD_Action = ["rallyCMD","Place Squad Rallypoint","",{[3,[],{[player,"TAS_cmdRallypoint","rallypointCmdMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
	[player, 1, ["ACE_SelfActions"], _Rally_CMD_Action] call ace_interact_menu_fnc_addActionToObject;
};

//["_sourceUnit","_rallyUsedBool","_rallyObjArray","_rallyName","_markerVarName"];
...
if (_playerClass == "ALPHA_Actual" || ("Squad Leader" in _playerRoleDescription && "Alpha" in _playerRoleDescription)) then { //doesn't handle nearly enough edge cases in role description names
	private _Rally_Alpha_Action = ["rallyAlpha","Place Squad Rallypoint","",{[3,[],{[player,"TAS_alphaRallypoint","rallypointAlphaMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
	[player, 1, ["ACE_SelfActions"], _Rally_Alpha_Action] call ace_interact_menu_fnc_addActionToObject;
};

if (_playerClass == "BRAVO_Actual" || ("Squad Leader" in _playerRoleDescription && "Bravo" in _playerRoleDescription)) then {
	private _Rally_Bravo_Action = ["rallyBravo","Place Squad Rallypoint","",{[3,[],{[player,"TAS_bravoRallypoint","rallypointBravoMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "CHARLIE_Actual" || ("Squad Leader" in _playerRoleDescription && "Charlie" in _playerRoleDescription)) then {
	private _Rally_Charlie_Action = ["rallyCharlie","Place Squad Rallypoint","",{[3,[],{[player,"TAS_charlieRallypoint","rallypointCharlieMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "DELTA_Actual" || ("Squad Leader" in _playerRoleDescription && "Delta" in _playerRoleDescription)) then {
	private _Rally_Delta_Action = ["rallyDelta","Place Squad Rallypoint","",{[3,[],{[player,"TAS_deltaRallypoint","rallypointDeltaMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "ECHO_Actual" || ("Squad Leader" in _playerRoleDescription && "Echo" in _playerRoleDescription)) then {
	private _Rally_Echo_Action = ["rallyEcho","Place Squad Rallypoint","",{[3,[],{[player,"TAS_echoRallypoint","rallypointEchoMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "FOXTROT_Actual" || ("Squad Leader" in _playerRoleDescription && "Foxtrot" in _playerRoleDescription)) then {
	private _Rally_Foxtrot_Action = ["rallyFoxtrot","Place Squad Rallypoint","",{[3,[],{[player,"TAS_foxtrotRallypoint","rallypointFoxtrotMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "GOLF_Actual" || ("Squad Leader" in _playerRoleDescription && "Golf" in _playerRoleDescription)) then {
	private _Rally_Golf_Action = ["rallyGolf","Place Squad Rallypoint","",{[3,[],{[player,"TAS_golfRallypoint","rallypointGolfMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "HOTEL_Actual" || ("Squad Leader" in _playerRoleDescription && "Hotel" in _playerRoleDescription)) then {
	private _Rally_Hotel_Action = ["rallyHotel","Place Squad Rallypoint","",{[3,[],{[player,"TAS_hotelRallypoint","rallypointHotelMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "Recon_Actual" || ("Leader" in _playerRoleDescription && "Recon" in _playerRoleDescription)) then { //assumes that recon is a smaller team without two leaders
	private _Rally_Recon_Action = ["rallyRecon","Place Squad Rallypoint","",{[3,[],{[player,"TAS_reconRallypoint","rallypointReconMarker"] call TAS_fnc_genericRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
