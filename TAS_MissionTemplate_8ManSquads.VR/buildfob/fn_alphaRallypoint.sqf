...
"rallypointAlphaMarker" setMarkerColorLocal _color;	//last marker command is public
"rallypointAlphaMarker" setMarkerText format ["%1 Rallypoint",groupId group player];
