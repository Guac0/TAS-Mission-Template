...
_QS_ST_enableGroupIcons = FALSE;								// BOOL. TRUE to enable Map+GPS+HUD GROUP Icons. Default TRUE. Unknown what this does
...
_QS_ST_showGroupOnly = TRUE;									// BOOL. Set TRUE to show ONLY the unit icons of THE PLAYERS GROUP MEMBERS on the MAP, FALSE to show ALL your factions units. May override other config. Default TRUE. NOTE: STILL SHOWS GROUP ICONS
